...
(function(){
    ...
    apytanka.service('Apytanka', ['profileCtrl', function(profileCtrl){
...
//            this.dislikes = data.dislikes || [];
        ...
        Apytanka.prototype.like = function(){
            console.log(profileCtrl.currentUser.id);
        };
    ...
    apytanka.controller('apytankaCtrl', ['$scope', 'Apytanka', function($scope, Apytanka){
        var apytanaList = [
                {id: '1', user: {name: 'Ivan', surname: 'Ivanov', id: 123, avatar: '../app/css/images/563469251.png', country: 'Thailand', city: 'Bangkok'}, title: "First", content: 'bla-bla-bla',
                date: 634600801000, rating: {likes: [2, 12, 125, 45, 85, 44], dislikes: [14,58,21]}},
                {id: '2', user: {name: 'Julian', surname: 'Cesar', id: 123, avatar: '', country: 'Italy', city: 'Rome'}, title: "AHAHAHAH",
                ...
                {id: '3', user: {name: 'Kiloak', surname: 'Kiser', id: 123, avatar: '', country: 'Germany', city: 'Berlin'}, title: "fsdadfg",
        ...
        angular.forEach(apytanaList, function(obj) {
